(function () {
  ...
  var ICONS = {
    ...
    listen: '<svg class="l3-ico" viewBox="0 0 24 24"><path d="M4 8v8M8 6v12M12 4v16M16 7v10M20 9v6"/></svg>',
    studio: '<svg class="l3-ico" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M12 3v2M12 19v2M3 12h2M19 12h2M5.6 5.6l1.4 1.4M17 17l1.4 1.4M5.6 18.4L7 17M17 7l1.4-1.4"/></svg>'
  };
  ...
  function mountBadge() {
    if (document.getElementById('l3-mcc-badge')) return;
    var b = document.createElement('a');
    b.id = 'l3-mcc-badge';
    b.href = MCC_BUY;
    b.target = '_blank';
    b.rel = 'noopener';
    b.innerHTML = '<span>Built & powered by</span><strong>McCluster</strong>';
